...
export const FeatureBoard = component$(() => {
  return (
    <section class="bg-[#30461D] rounded-[10px] text-white p-[1em] mx-0 my-[1em] md:mx-[1em]">
      <div class="border-4 border-solid border-white rounded-[10px] p-[1em] flex flex-col gap-4 items-center md:flex-row md:items-start">
